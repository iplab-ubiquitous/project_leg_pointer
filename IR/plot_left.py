...
import_file = np.loadtxt("./exp_data/leg/data_left_0109.csv", delimiter=',', skiprows=1)
file_P1 = np.loadtxt("./exp_data/leg/data_P1/P1_left.csv", delimiter=',', skiprows=1)
file_P2 = np.loadtxt("./exp_data/leg/data_P2/P2_left.csv", delimiter=',', skiprows=1)
file_P3 = np.loadtxt("./exp_data/leg/data_P3/P3_left.csv", delimiter=',', skiprows=1)
...
plt.scatter(imp1_x, imp1_y, s=30, marker="o",   label='selection time (P1)', c="black")
...
plt.xlim(1.0, 4.5)
#plt.show()
plt.savefig('left.pdf', format="pdf")
