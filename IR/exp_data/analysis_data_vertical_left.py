...
plt.title("左膝の選択時間（垂直操作のみ抽出）", fontsize=16)
...
throughput[0], error[0] = fitts_fit(
    "P1", "./leg/data_p1_left_vertical.csv", 0, '^')
throughput[1], error[1] = fitts_fit(
    "P2", "./leg/data_p2_left_vertical.csv", 1, 'x')
throughput[2], error[2] = fitts_fit(
    "P3", "./leg/data_p3_left_vertical.csv", 2, '+')
throughput[3], error[3] = fitts_fit(
    "P4", "./leg/data_p4_left_vertical.csv", 3, '+')
